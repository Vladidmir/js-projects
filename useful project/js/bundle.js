    ...
    function getDynamicInformation(selector) {
        ...
        input.addEventListener('input', () => {
            ...
            if (input.value.match(/\D/g)) {
                input.style.border = '2px solid rgb(255, 88, 79)';
            } else {
                input.style.border = '1px solid #54ed39';
            }

            input.value ? ' ' : input.style.border = 'none';
...
function slider({
    ...
    function activeElem(slideIndex, slidesLenght) {
    ...
    next.addEventListener('click', () => {
        ...
        activeElem(slideIndex, slides.lenght);
    ...
    prev.addEventListener('click', () => {
        ...
        activeElem(slideIndex, slides.length);
    });
